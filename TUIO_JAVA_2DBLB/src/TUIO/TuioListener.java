...
public interface TuioListener {
	 ...
	 */
	public void addTuioBlob(TuioBlob tcur);

	/**
	 * This callback method is invoked by the TuioClient when an existing TuioBlob is updated during the session.   
	 *
	 * @param  tcur  the TuioBlob reference associated to the updateTuioBlob event
	 */
	public void updateTuioBlob(TuioBlob tcur);

	/**
	 * This callback method is invoked by the TuioClient when an existing TuioBlob is removed from the session.   
	 *
	 * @param  tcur  the TuioBlob reference associated to the removeTuioBlob event
	 */
	public void removeTuioBlob(TuioBlob tcur);
